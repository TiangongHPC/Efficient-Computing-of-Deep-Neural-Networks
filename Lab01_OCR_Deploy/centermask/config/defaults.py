...
_C.INPUT.RANDOM_SCALE = CN()
_C.INPUT.RANDOM_SCALE.ENABLED = True
_C.INPUT.RANDOM_SCALE.MIN_SCALE = 0.8
_C.INPUT.RANDOM_SCALE.MAX_SCALE = 2.4

_C.INPUT.RANDOM_FLIP = None
_C.INPUT.RANDOM_HFLIP = False
_C.INPUT.RANDOM_VFLIP = False